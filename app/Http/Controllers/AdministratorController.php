...
//            //->simplePaginate(5);
            ...
            return view('administrators.index', ['users' => $users, 'search' => $query]);
        }
//        $users = User::all();
//        return view('usuarios.index', ['users' => $users ]);
    ...
    {
        $roles = Role::all();
        return view('administrators.create', ['roles' => $roles]);
    }
...
//        $usuario->password = $request('password');
    ...
    {
        return view('administrators.show', ['user' => User::findOrFail($id)]);
    }
    ...
    public function edit($id)
    {
        ...
        $roles = Role::all();
        return view('administrators.edit', ['user' => $user, 'roles' => $roles]);
    }
