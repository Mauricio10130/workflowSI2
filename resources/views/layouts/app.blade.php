...
<div class="wrapper">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                <div class="info">
                    <a href="#" class="d-block">
                        ...
                        @else
                            <div class="image">
                                <img src="{{asset('imagenes/'.\Illuminate\Support\Facades\Auth::user()->imagen)}}"
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ url('departamentos') }}"
                                   class="{{ Request::path() === 'departamentos' ? 'nav-link active' : 'nav-link' }}">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2020-2020 <a href="http://adminlte.io">WORKFLOW</a>.</strong>
        All rights reserved.
