<!-- Modal -->
<div class="modal fade" id="modalEliminar-{{ $role->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
     aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ¿Estas seguro que quieres eliminar el rol <strong>{{ $role->name }}</strong>?
            </div>
